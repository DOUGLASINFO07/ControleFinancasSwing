...
public class RelatorioContas {
    ...
    public void imprimir(
        ...
        setItemUmPesquisaRelatorioContas(dataInicial.getText());
        setItemDoisPesquisaRelatorioContas(dataFinal.getText());
        setParametroPesquisaRelatorioContas(parametroPesquisaRelatorioContas.getSelectedItem().toString());
        setMensagemPesquisa(mensagem.getText());

        String dataInicio;
        if ("  -  -    ".equals(getItemUmPesquisaRelatorioContas())) {
            dataInicio = "2000-01-01";
        } else {
            dataInicio = util.converterDataBrasilAmericano(getItemUmPesquisaRelatorioContas());
        }
        
        String dataFim;
        if ("  -  -    ".equals(getItemDoisPesquisaRelatorioContas())) {
            dataFim = "2000-01-01";
        } else {
            dataFim = util.converterDataBrasilAmericano(getItemDoisPesquisaRelatorioContas());
        }
        ...
        if ("Mês Atual".equals(parametroPesquisaRelatorioContas.getSelectedItem().toString())) {

            //variável que artmazena o caminho do relatório
            relatorio = "src/relatorio/RelatorioContasMesAtual.jasper";

        } else if ("Boletos Vencidos Mês Atual".equals(parametroPesquisaRelatorioContas.getSelectedItem().toString())) {

            //variável que artmazena o caminho do relatório
            relatorio = "src/relatorio/RelatorioContasBoletosVencidosMesAtual.jasper";

        } else if ("Boletos à Vencer Mês Atual".equals(parametroPesquisaRelatorioContas.getSelectedItem().toString())) {

            //variável que artmazena o caminho do relatório
            relatorio = "src/relatorio/RelatorioContasBoletosVencerMesAtual.jasper";

        } else if ("Boletos à Vencer".equals(parametroPesquisaRelatorioContas.getSelectedItem().toString())) {

            //variável que artmazena o caminho do relatório
            relatorio = "src/relatorio/RelatorioContasBoletosVencer.jasper";

        } else if ("Boletos Vencidos".equals(parametroPesquisaRelatorioContas.getSelectedItem().toString())) {

            //variável que artmazena o caminho do relatório
            relatorio = "src/relatorio/RelatorioContasBoletosVencidos.jasper";

        } else if ("Boletos Pagos".equals(parametroPesquisaRelatorioContas.getSelectedItem().toString())) {

            //variável que artmazena o caminho do relatório
            relatorio = "src/relatorio/RelatorioContasBoletosPagos.jasper";

        } else if ("Boletos à Pagar".equals(parametroPesquisaRelatorioContas.getSelectedItem().toString())) {

            //variável que artmazena o caminho do relatório
            relatorio = "src/relatorio/RelatorioContasBoletosPagar.jasper";

        } else if ("Período de Boletos Vencidos".equals(parametroPesquisaRelatorioContas.getSelectedItem().toString())) {

            //variável que artmazena o caminho do relatório
            relatorio = "src/relatorio/RelatorioContasPeriodoBoletosVencidos.jasper";

        } else if ("Período de Boletos Pagos".equals(parametroPesquisaRelatorioContas.getSelectedItem().toString())) {

            //variável que artmazena o caminho do relatório
            relatorio = "src/relatorio/RelatorioContasPeriodoBoletosPagos.jasper";

        } else if ("Data de Vencimento do Boleto".equals(parametroPesquisaRelatorioContas.getSelectedItem().toString())) {

            //variável que artmazena o caminho do relatório
            relatorio = "src/relatorio/RelatorioContasDataVencimentoBoleto.jasper";

        } else if ("Data de Pagamento do Boleto".equals(parametroPesquisaRelatorioContas.getSelectedItem().toString())) {

            //variável que artmazena o caminho do relatório
            relatorio = "src/relatorio/RelatorioContasDataPagamentoBoleto.jasper";
            
        } else if ("Todos os Boletos".equals(parametroPesquisaRelatorioContas.getSelectedItem().toString())) {

            //variável que artmazena o caminho do relatório
            relatorio = "src/relatorio/RelatorioContasTodosBoletos.jasper";
            
        } else {

            //variável que artmazena o caminho do relatório
            relatorio = "src/relatorio/RelatorioContasEmpresaGerouBoleto.jasper";
        ...
        Relatorios(
                  ...
                  dataFinalMes,
                  dataAtual,
                  getParametroPesquisaRelatorioContas(),
                  dataInicio,
                  dataFim,
                  getMensagemPesquisa()
        );
